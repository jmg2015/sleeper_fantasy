---
title: "TLST 2018 NFL Retrospective"
...
Well look at that. Jon and Joe were the same even even though Jon scored more on average. My red bar is so short. Hopefully, this whole API thing will help me right the ship. 
...
ggplot(data = weekly_owner_scores_melt0, aes(x = Week, y = value, color = Points, group = Points)) +
  ...
  geom_hline(data = avg_owner_score, 
             ...
             colour = "#FF2700", linetype = "dashed", size = 1.15) + 
  geom_hline(data = avg_owner_score, 
             aes(yintercept = avg_points_against), 
             colour = "#008fd5", linetype = "dashed", size = 1.15) + 
  facet_wrap(~Owner) + 
